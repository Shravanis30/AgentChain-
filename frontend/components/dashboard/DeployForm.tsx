  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200 dark:border-slate-800">
        ...
        {/* Tab Switcher */}
        <div className="p-1 rounded-2xl bg-slate-200/80 dark:bg-slate-900 border border-slate-300 dark:border-slate-800 flex items-center shadow-inner self-start sm:self-auto">
          <button
            type="button"
            ...
            {isLive && (
              <div className="flex items-center space-x-3">
                <a
                  ...
                  className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold font-mono text-xs shadow-md transition-colors inline-flex items-center space-x-1.5"
                >
                ...
                <button
                  ...
                  className="px-3.5 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-mono text-xs font-bold hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
                >
                ...
                <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 space-y-6 shadow-xl">
                      ...
                      {envVars.map((env, idx) => (
                        <div key={idx} className="flex items-center space-x-2">
                          <input
                            ...
                            className="w-1/2 px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs font-mono text-slate-900 dark:text-white"
                          />
                          <input
                            type="text"
                            placeholder="value"
                  ...
                  <div className="pt-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 hover:opacity-95 text-white font-bold font-mono text-sm shadow-xl shadow-cyan-500/20 transition-all flex items-center space-x-2 min-h-[44px]"
                    >
                      <Sparkles className="w-4 h-4" />
        ...
        <form onSubmit={handleDeployExistingAgent} className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 space-y-6 shadow-xl">
          ...
          <div className="pt-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
            ...
            <button
              ...
              className="px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 hover:opacity-95 text-white font-bold font-mono text-sm shadow-xl shadow-cyan-500/20 transition-all flex items-center space-x-2 min-h-[44px]"
            >
